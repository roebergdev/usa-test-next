...
// Difficulty slots for the 7-question daily quiz — all easy
const DAILY_DIFFICULTIES = [1, 1, 1, 1, 1, 1, 1] as const;
 ...
 *
 * Returns the same 7 questions for every user on a given calendar day.
