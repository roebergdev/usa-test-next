      ...
      <div className="relative space-y-5 sm:space-y-7">
        ...
        {!dailyResult && (
          <button onClick={onPlayDaily} className="group relative w-full sm:w-fit mb-4 sm:mb-6">
            ...
            <div className="relative px-8 sm:px-14 py-4 sm:py-5 bg-amac-red text-white rounded-xl sm:rounded-2xl font-black text-lg sm:text-xl flex items-center justify-center gap-3 hover:bg-amac-red/90 transition-all hover:-translate-y-0.5 active:translate-y-0 shadow-xl shadow-amac-red/25 animate-pulse-fast">
